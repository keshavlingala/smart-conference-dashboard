...
export class DevicesService {
      ...
      "devices": [
        {
          ...
          "credentials": {
            ...
            "accessToken": "cd8c8e16-e2c0-42c6-9093-4fa66627a034"
          },
          "operations": {
            "deviceStatus": true,
            "deviceRules": []
  ...
  getAllDevices(){
    return this.devicesData.data.devices;
  }

  getDevices(startIndex:number , endIndex : number)
  {
     return this.devicesData.data.devices.slice(startIndex , endIndex);
  }


  getCount(){
    return this.devicesData.data;
  }
