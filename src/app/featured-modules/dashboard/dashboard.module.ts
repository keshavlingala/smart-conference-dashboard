...
@NgModule({
  declarations: [DashboardHomeComponent, DashboardAddWidgetComponent, PopUpAddDashboardComponent, CustomFormHostDirective, GuageFormComponent, LineFormComponent, DashboardComponent, ChartjsComponent, ChartistComponent, GoogleChartsComponent],
  imports: [
    CommonModule,
